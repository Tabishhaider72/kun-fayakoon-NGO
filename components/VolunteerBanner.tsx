  ...
  return (
    <section className="relative w-full py-12 sm:py-16 bg-[#EDEDED] overflow-hidden">
      <motion.div
        ...
        viewport={{ once: true }}
        className="max-w-6xl mx-auto px-4 sm:px-6 flex flex-col items-center justify-center text-center relative"
      >
        <div className="relative w-full overflow-hidden">
          ...
          {/* ✅ Mobile Video - cylindrical top/bottom shape */}
          {isMobile && (
            <div className="w-full overflow-hidden">
              <video
                ...
                loop
                playsInline
                className="w-full h-auto object-cover rounded-t-[120px] rounded-b-[120px]"
              />
            </div>
          )}
