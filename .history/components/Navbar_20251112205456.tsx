    ...
    >
      ...
      <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="hidden md:block">
        <Button
          ...
          className="flex items-center gap-2 bg-[#2E8B57] hover:bg-[#267948] text-white rounded-md px-6 py-2 shadow-md"
        >
      ...
      <AnimatePresence>
        {menuOpen && (
          ...
          >
            <Link href="/" onClick={() => setMenuOpen(false)} className="flex items-center gap-2 text-[#111D15] hover:text-[#2E8B57] transition">
              <FaHome className="text-[#2E8B57]" /> Home
            </Link>
            <Link href="/about" onClick={() => setMenuOpen(false)} className="flex items-center gap-2 text-[#111D15] hover:text-[#2E8B57] transition">
              <FaInfoCircle className="text-[#2E8B57]" /> About us
            </Link>
            <Link href="/donations" onClick={() => setMenuOpen(false)} className="flex items-center gap-2 text-[#111D15] hover:text-[#2E8B57] transition">
              <FaDonate className="text-[#2E8B57]" /> Donations
            </Link>
            <Link href="/campaigns" onClick={() => setMenuOpen(false)} className="flex items-center gap-2 text-[#111D15] hover:text-[#2E8B57] transition">
              <FaHandsHelping className="text-[#2E8B57]" /> Campaigns
            </Link>
            <Link href="/blogs" onClick={() => setMenuOpen(false)} className="flex items-center gap-2 text-[#111D15] hover:text-[#2E8B57] transition">
              <FaBlog className="text-[#2E8B57]" /> Blogs
            </Link>
