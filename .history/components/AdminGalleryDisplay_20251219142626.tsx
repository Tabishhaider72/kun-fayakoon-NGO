...
import { getGalleryImages, deleteGalleryImageServer } from "@/lib/gallery-actions";
          ...
          >
            ...
            >
              ...
              <div className="absolute inset-0 overlay flex items-center justify-center">
                <div className="overlay-icon opacity-0 transition-all duration-300">
            ...
            <div className="gallery-content p-4">
              {/* No title displayed in admin gallery per requirement */}
