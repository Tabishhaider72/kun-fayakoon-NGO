...
import { FaGraduationCap, FaHandHoldingMedical, FaLeaf, FaAppleAlt, FaArrowRight } from "react-icons/fa";
...
export default function DonationSection() {
  return (
    <section className="relative w-full bg-white overflow-hidden py-20 px-6 sm:px-10 lg:px-16">
      <div className="max-w-7xl mx-auto text-center">
        ...
        >
          Your Donation Brings Smiles And <br className="hidden sm:block" /> Transforms Lives
        </motion.h2>
