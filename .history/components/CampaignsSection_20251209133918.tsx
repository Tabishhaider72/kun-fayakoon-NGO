...
export default function CampaignsSection() {
  return (
    <section id="campaigns-section" className="relative w-full bg-white py-20 px-6 sm:px-10 lg:px-16 overflow-hidden">
