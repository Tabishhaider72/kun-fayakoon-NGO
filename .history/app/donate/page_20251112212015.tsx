  ...
  return (
    <>
      ...
      <section className="min-h-screen flex flex-col items-center justify-center text-center bg-gradient-to-b from-[#FFF7ED] to-[#EDEDED] relative overflow-hidden px-6">
        ...
        >
          <h1
            className={`${poppins.className} text-[#111D15] font-extrabold text-[11vw] sm:text-[8vw] lg:text-[6vw] leading-[1.1] flex flex-wrap justify-center items-center gap-4`}
          >
            <span>Hope</span>
            <div className="relative w-[120px] sm:w-[180px] h-[120px] sm:h-[180px] overflow-hidden rounded-full border-[6px] border-[#2E8B57]/20 shadow-lg">
              <Image
                src="/donate-hero.png"
                alt="Donation Hero"
                fill
          ...
          <h2
            className={`${poppins.className} text-[#111D15] font-extrabold text-[9vw] sm:text-[7vw] lg:text-[5vw] mt-3`}
          >
            is Support
          </h2>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-12">
            <button
              ...
              className="bg-[#2E8B57] hover:bg-[#267948] text-white font-semibold text-lg px-12 py-4 rounded-full shadow-md transition-all duration-300"
            >
              Donate
            </button>
            <button className="border border-[#2E8B57] text-[#2E8B57] hover:bg-[#2E8B57] hover:text-white font-semibold text-lg px-12 py-4 rounded-full transition-all duration-300">
              I Need Help →
            </button>
          </div>
        </motion.div>
      ...
      >
        <motion.div
          ...
          viewport={{ once: true }}
          className="w-full max-w-lg bg-[#F8F9F8] rounded-2xl shadow-lg p-10 text-center border border-[#E5E5E5]"
        >
          <h3
