// DEPRECATED: This file is superseded by gallery-actions.ts which uses Prisma + Supabase
// The GalleryDynamic component that uses this is also deprecated - use GalleryDisplay or AdminGalleryDisplay instead

// This file is deprecated and replaced by `lib/gallery-actions.ts` which uses Prisma + Supabase.
// Keep lightweight placeholders here so any accidental imports don't pull heavy Firebase types.
